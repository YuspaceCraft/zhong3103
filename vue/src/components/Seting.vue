<template>
  ...
  import {reqfinduser1,requpdateuser1,reqId} from '../utils/request.js'
    export default {
      data() {
      ...
      methods: {
        fetchTableData() {
          ...
          reqId().then((res) => {
               ...
               //this.userid = res.data;
                   ...
                   reqfinduser1(this.userid).then((response) => {
        ...
        submitForm(formName) {
          ...
          requpdateuser1(this.userid,this.ruleForm.username,this.ruleForm.pass,this.ruleForm.age,
